...
void main()
{
	...
	outColor += 0.091637 * texture(uTex, vec2(texCoord.x - 4.0 * uPixelSize, texCoord.y)).rgb;
	outColor += 0.105358 * texture(uTex, vec2(texCoord.x - 3.0 * uPixelSize, texCoord.y)).rgb;
	outColor += 0.116400 * texture(uTex, vec2(texCoord.x - 2.0 * uPixelSize, texCoord.y)).rgb;
	outColor += 0.123573 * texture(uTex, vec2(texCoord.x - uPixelSize, texCoord.y)).rgb;
